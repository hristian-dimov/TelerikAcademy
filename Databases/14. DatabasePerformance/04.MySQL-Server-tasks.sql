...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Databases/13. Database Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql at master · skirov/Databases</title>
...
<meta content="zChDlRW+zzr5VcfTB5tBJ2MSMLkRbbtcpjdP5D9bS8o=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-07b5a2f9ead69e413a4a39b8bf0414aba066b0aa.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="2e2c3f3588b9b3a98ed45f34834b2e61">
        ...
        <link data-pjax-transient rel='permalink' href='/skirov/Databases/blob/d67cec80c34b6438e997c49d431d2bf090a7918e/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql'>
...
<!-- blob contrib key: blob_contributors:v21:2ed9e2b1e323af8cfc19a80c61278906 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:2ed9e2b1e323af8cfc19a80c61278906 -->
...
<div class="select-menu js-menu-container js-select-menu" >
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/skirov/Databases/blob/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
        </div>
  ...
  <div class="commit file-history-tease">
    ...
    <time class="js-relative-date" datetime="2013-07-19T09:52:10-07:00" title="2013-07-19 09:52:10">July 19, 2013</time>
    <div class="commit-title">
        <a href="/skirov/Databases/commit/f9b8381d1731e704205bd8dcb278f6648d3ba124" class="message" data-pjax="true" title="small fix">small fix</a>
    </div>
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped leftwards"
                   ...
                   href="/skirov/Databases/edit/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/skirov/Databases/raw/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql" class="button minibutton " id="raw-url">Raw</a>
            <a href="/skirov/Databases/blame/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql" class="button minibutton ">Blame</a>
          <a href="/skirov/Databases/commits/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
            <a class="minibutton danger empty-icon tooltipped downwards"
               href="/skirov/Databases/delete/master/13.%20Database%20Performance/13.DatabasePerformance-Homework/04.MySQL-Server-tasks.sql"
...
<span id="L20" rel="#L20">20</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="k">DELIMITER</span> <span class="err">$$</span></div><div class='line' id='LC2'><span class="k">DROP</span> <span class="k">PROCEDURE</span> <span class="n">IF</span> <span class="k">EXISTS</span> <span class="n">insert_million_rows</span> <span class="err">$$</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="k">CREATE</span> <span class="k">PROCEDURE</span> <span class="n">InsertMilionRowsInDB</span> <span class="p">()</span> </div><div class='line' id='LC5'><span class="k">BEGIN</span></div><div class='line' id='LC6'><span class="k">DECLARE</span> <span class="n">counter</span> <span class="nb">INT</span> <span class="k">DEFAULT</span> <span class="mi">0</span><span class="p">;</span></div><div class='line' id='LC7'>	<span class="k">START</span> <span class="n">TRANSACTION</span><span class="p">;</span></div><div class='line' id='LC8'>	<span class="n">WHILE</span> <span class="n">counter</span> <span class="o">&lt;</span> <span class="mi">1000000</span> <span class="k">DO</span></div><div class='line' id='LC9'>		<span class="k">INSERT</span> <span class="k">INTO</span> <span class="n">Logs</span><span class="p">(</span><span class="n">LogDate</span><span class="p">,</span> <span class="n">LogText</span><span class="p">)</span></div><div class='line' id='LC10'>		<span class="k">VALUES</span><span class="p">(</span><span class="n">TIMESTAMPADD</span><span class="p">(</span><span class="k">DAY</span><span class="p">,</span> <span class="n">FLOOR</span><span class="p">(</span><span class="mi">1</span> <span class="o">+</span> <span class="n">RAND</span><span class="p">()</span> <span class="o">*</span> <span class="mi">10000</span><span class="p">),</span> <span class="s1">&#39;1990-01-01&#39;</span><span class="p">),</span></div><div class='line' id='LC11'>		<span class="n">CONCAT</span><span class="p">(</span><span class="s1">&#39;Sample text &#39;</span><span class="p">,</span> <span class="n">counter</span><span class="p">));</span></div><div class='line' id='LC12'><span class="k">SET</span> <span class="n">counter</span> <span class="o">=</span> <span class="n">counter</span> <span class="o">+</span> <span class="mi">1</span><span class="p">;</span></div><div class='line' id='LC13'><span class="k">END</span> <span class="n">WHILE</span><span class="p">;</span></div><div class='line' id='LC14'><span class="k">END</span> <span class="err">$$</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'><span class="k">CALL</span> <span class="n">InsertMilionRowsInDB</span> <span class="p">();</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="k">SELECT</span> <span class="o">*</span> <span class="k">FROM</span> <span class="n">logs</span> <span class="n">PARTITION</span><span class="p">(</span><span class="n">p2</span><span class="p">);</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="k">SELECT</span> <span class="o">*</span> <span class="k">FROM</span> <span class="n">logs</span> <span class="k">WHERE</span> <span class="k">YEAR</span><span class="p">(</span><span class="n">LogDate</span><span class="p">)</span> <span class="o">=</span> <span class="mi">1995</span><span class="p">;</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.06097s from fe3.rs.github.com">GitHub</span>, Inc.</li>
