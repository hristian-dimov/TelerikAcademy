...
window.viewsFactory = (function () {
	...
	function getCreateNewAppointmentView() {
	    return getTemplate("createAppointment");
	}
	...
	function getCreateNewListView() {
	    return getTemplate("createTodoList");
	}

	function getCreateNewTodoView() {
	    return getTemplate("createTodo");
	}

	return {
	    getLoginView: getLoginView,
	    getAppointmentsView: getAppointmentsView,
	    getCreateNewAppointmentView: getCreateNewAppointmentView,
	    getListsView: getListsView,
	    getCreateNewListView: getCreateNewListView,
	    getCreateNewTodoView: getCreateNewTodoView
	};
}());